...
filename="data/FlightPrice.csv"
f= open(filename,"w")
headers="Owner,From,To,RAM,DDR/SDR,HardDisk,Processor,OS,Pricing,Customer,Rating\n"
f.write(headers)

URL = 'https://www.goibibo.com/flights/air-HYD-CJB-20191217--1-0-0-E-D/'
